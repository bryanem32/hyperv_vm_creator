            ...
            try {
                ...
                if ($StartVMCheckbox.Checked) {
                    try {
                        ...
                        if ($existing) {
                            Write-Log ("A console for [$($vm.VMName)] is already open. Skipping...")
                        } else {
                            Write-Log ("Opening console for [$($vm.VMName)...")
...
$LogBox.Size = New-Object System.Drawing.Size(640,200)
$Form.Controls.Add($LogBox)

# Update button
$UpdateButton = New-Object System.Windows.Forms.Button
$UpdateButton.Text = "Update GPU"
$UpdateButton.Location = New-Object System.Drawing.Point(20,520)
...
$ExitButton.Location = New-Object System.Drawing.Point(160,520)
