...
$form.Text = "Hyper-V VM Creator v32"
...
$lblProfile.Text = "VM Profile:"
$lblProfile.AutoSize = $true
$lblProfile.Location = New-Object System.Drawing.Point(20,460)
$form.Controls.Add($lblProfile)

$comboProfile = New-Object System.Windows.Forms.ComboBox
$comboProfile.Width = 300
$comboProfile.Location = New-Object System.Drawing.Point(150,460)
...
$profiles = @(
    "MANUAL",
    "Windows 10 2004",
    "Windows 10 2004 Parsec",
    "Windows 10 22H2",
    "Windows 10 22H2 Parsec",
    "Windows 11 23H2/24H2",
    "Windows 11 23H2/24H2 Parsec",
    "Windows 11 25H2",
    "Windows 11 25H2 Parsec",
    "Windows 11 25H2 V2",
    "Windows 11 25H2 V2 Parsec"
)

$comboProfile.Items.Clear()
$comboProfile.Items.AddRange($profiles)
$comboProfile.SelectedItem = "MANUAL"

# Checkboxes
$chkCheckpoint = New-Object System.Windows.Forms.CheckBox
$chkCheckpoint.Text = "Enable Checkpoints"
$chkCheckpoint.AutoSize = $true
$chkCheckpoint.Location = New-Object System.Drawing.Point(600,20)
...
$chkDynamicMemory.Location = New-Object System.Drawing.Point(880,20)
...
$chkEnhancedSession.Location = New-Object System.Drawing.Point(600,60)
...
$chkStartVM.Location = New-Object System.Drawing.Point(880,60)
...
$lblSoftware.Location = New-Object System.Drawing.Point(600,100)
...
$chkParsec.Location = New-Object System.Drawing.Point(600,140)
...
$chkVBCable.Location = New-Object System.Drawing.Point(880,140)
...
$chkUSBMMIDD.Location = New-Object System.Drawing.Point(600,180)
$chkUSBMMIDD.Checked = $false
$form.Controls.Add($chkUSBMMIDD)

$chkRDP = New-Object System.Windows.Forms.CheckBox
$chkRDP.Text = "Remote Desktop"
$chkRDP.AutoSize = $true
$chkRDP.Location = New-Object System.Drawing.Point(880,180)
$chkRDP.Checked = $false
$form.Controls.Add($chkRDP)

$chkSHARE = New-Object System.Windows.Forms.CheckBox
$chkSHARE.Text = "Share Folder"
$chkSHARE.AutoSize = $true
$chkSHARE.Location = New-Object System.Drawing.Point(600,220)
$chkSHARE.Checked = $false
$form.Controls.Add($chkSHARE)

$chkPAUSEUPDATE = New-Object System.Windows.Forms.CheckBox
$chkPAUSEUPDATE.Text = "Pause Windows Updates"
$chkPAUSEUPDATE.AutoSize = $true
$chkPAUSEUPDATE.Location = New-Object System.Drawing.Point(880,220)
$chkPAUSEUPDATE.Checked = $false
$form.Controls.Add($chkPAUSEUPDATE)

$chkFULLUPDATE = New-Object System.Windows.Forms.CheckBox
$chkFULLUPDATE.Text = "Full Windows Updates"
$chkFULLUPDATE.AutoSize = $true
$chkFULLUPDATE.Location = New-Object System.Drawing.Point(600,260)
$chkFULLUPDATE.Checked = $false
$form.Controls.Add($chkFULLUPDATE)

$chkSHORTCUT = New-Object System.Windows.Forms.CheckBox
$chkSHORTCUT.Text = "Create Desktop Shortcut"
$chkSHORTCUT.AutoSize = $true
$chkSHORTCUT.Location = New-Object System.Drawing.Point(880,260)
...
$comboProfile.Add_SelectedIndexChanged({
    switch ($comboProfile.SelectedItem) {
        "MANUAL" {
            $chkCheckpoint.Checked = $false
            $chkDynamicMemory.Checked = $false
            $chkEnhancedSession.Checked = $false
            $chkStartVM.Checked = $false
            $chkParsec.Checked = $false
            $chkVBCable.Checked = $false
            $chkUSBMMIDD.Checked = $false
            $chkRDP.Checked = $false
        ...
        "Windows 10 2004" {
            ...
            $chkDynamicMemory.Checked = $false
            $chkEnhancedSession.Checked = $false
            $chkStartVM.Checked = $true
            $chkParsec.Checked = $false
            $chkVBCable.Checked = $false
            $chkUSBMMIDD.Checked = $false
            $chkRDP.Checked = $true
            $chkSHARE.Checked = $true
            $chkPAUSEUPDATE.Checked = $true
            $chkFULLUPDATE.Checked = $false
        ...
        "Windows 10 2004 Parsec" {
            ...
            $chkEnhancedSession.Checked = $false
            $chkStartVM.Checked = $true
            $chkParsec.Checked = $true
            $chkVBCable.Checked = $true
            $chkUSBMMIDD.Checked = $true
            $chkRDP.Checked = $true
            $chkSHARE.Checked = $true
            $chkPAUSEUPDATE.Checked = $true
            $chkFULLUPDATE.Checked = $false
...
$logBox.Width=540
$logBox.Height=150
$logBox.Location = New-Object System.Drawing.Point(600,300)
...
$btnCreate.Location = New-Object System.Drawing.Point(450,520)
$form.Controls.Add($btnCreate)

$btnCancel = New-Object System.Windows.Forms.Button
$btnCancel.Text="EXIT"; $btnCancel.Size=New-Object System.Drawing.Size(100,30)
$btnCancel.Location = New-Object System.Drawing.Point(600,520)
...
# LogBox Header Text
$controls["LogBox"].AppendText("Hyper-V VM Creator v32 `r`n")
...
"@
        ...
        if ($chkRDP.Checked) {
            $lines += @(
                ...
                'echo [%date% %time%] Enabling Remote Desktop... >> %LOGFILE%'
                'reg add "HKLM\SYSTEM\CurrentControlSet\Control\Terminal Server" /v fDenyTSConnections /t REG_DWORD /d 0 /f'
                'echo [%date% %time%] Allowing Firewall for RDP... >> %LOGFILE%'
        ...
        if ($chkSHARE.Checked) {
            $lines += @(
                ':: --- Schedule user share creation for first logon ---'
                'echo [%date% %time%] Scheduling share creation on first login... >> %LOGFILE%'
        ...
        if ($chkPAUSEUPDATE.Checked) {
            $lines += @(
                ...
                'echo [%date% %time%] Pausing Windows Updates for 1 year... >> %LOGFILE%'
                ...
                'echo [%date% %time%] Windows Updates paused for 1 year. >> %LOGFILE%'
                ''
            )
        }

        if ($chkFULLUPDATE.Checked) {
            $lines += @(
                ':: --- Schedule full Windows + .NET + Preview Updates for first logon ---'
                'echo [%date% %time%] Scheduling full Windows + .NET + Preview Update on first login... >> %LOGFILE%'
                ...
                'echo powershell -ExecutionPolicy Bypass -NoProfile -Command "try { Install-PackageProvider -Name NuGet -Force; [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Install-Module PSWindowsUpdate -Force -Scope AllUsers; Import-Module PSWindowsUpdate; Add-WUServiceManager -MicrosoftUpdate -Confirm:$false -ErrorAction SilentlyContinue; reg add \"HKLM\SOFTWARE\Microsoft\WindowsUpdate\UX\Settings\" /v IsContinuousInnovationOptedIn /t REG_DWORD /d 1 /f; reg add \"HKLM\SOFTWARE\Microsoft\WindowsUpdate\UX\Settings\" /v FlightSettingsMaxBuildNumber /t REG_DWORD /d 999999 /f; reg add \"HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\" /v AllowOptionalContent /t REG_DWORD /d 1 /f; Write-Output (''['' + (Get-Date) + ''] Checking for ALL Windows updates including previews...''); Get-WindowsUpdate -MicrosoftUpdate -Install -AcceptAll -IgnoreReboot -Category ''Security Updates'',''Critical Updates'',''Update Rollups'',''Feature Packs'',''Service Packs'',''Tools'',''Update Rollups'',''Updates'',''Definition Updates'',''Drivers'',''Preview'',''Preview Builds'' | Out-File -FilePath C:\\Windows\\Temp\\WUOutput.log -Encoding UTF8; Write-Output (''['' + (Get-Date) + ''] Updates completed successfully.''); } catch { Write-Output (''['' + (Get-Date) + ''] Update process failed: '' + $_.Exception.Message); }" >> C:\Windows\Temp\RunUpdates.cmd'
                'echo shutdown /r /t 5 /c "Windows Updates complete. System will reboot in 5 seconds." >> C:\Windows\Temp\RunUpdates.cmd'
        ...
        if ($null -eq $Password) {
            Generate-UnattendXml -Username $Username -Password $null -VMName $VMName -ResWidth $ResWidth -ResHeight $ResHeight | Out-File -FilePath $UnattendXMLPath -Encoding UTF8
        } else {
        ...
        # Create Desktop VM Shortcut
        if ($chkSHORTCUT.Checked) {
            Write-Log "Creating Desktop Shortcut for $VMName."
            $ShortcutPath = "$env:USERPROFILE\Desktop\$VMName.lnk"

            # Create shortcut
            $WshShell = New-Object -ComObject WScript.Shell
            $Shortcut = $WshShell.CreateShortcut($ShortcutPath)
            $Shortcut.TargetPath = "$env:SystemRoot\System32\vmconnect.exe"
            $Shortcut.Arguments  = "localhost `"$VMName`""
            $Shortcut.IconLocation = "$env:SystemRoot\System32\vmconnect.exe"
            $Shortcut.Save()
 
            # Enable "Run as administrator"
            $bytes = [System.IO.File]::ReadAllBytes($ShortcutPath)

            # Byte 0x15 contains shortcut flags
            # Bit 0x20 = Run as administrator
